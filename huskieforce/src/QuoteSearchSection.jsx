...
function QuoteSearchSection({allQuotes, onEditQuote, customers, allLineItems, salesAssociates}) {
 ...
 const filtered = allQuotes.filter((q) => {
   const customerName = customers.find(c => c.id === q.CU_ID)?.name?.toLowerCase() || "";
   const associateName = salesAssociates.find(a => a.SA_ID === q.SA_ID)?.Name?.toLowerCase() || "";
   ...
   return (
     ...
     (!filters.associate || associateName.includes(filters.associate.toLowerCase())) &&
